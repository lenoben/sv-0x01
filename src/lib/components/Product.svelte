<script>
	...
	import selection from '$lib/assets/selection.png?enhanced';
	import training from '$lib/assets/training.png?enhanced';
	import goal from '$lib/assets/goal.png?enhanced';
	...
	let productFeatures = [
		{
			...
			description:
				'Stellar Styles ensures all users have the information they need to train safely and train effectively.',
			imgUrl: selection
		},
		{
			featureList: [
